...
​	This document will show you how to online connect a LiDAR or offline decode pcap to  send point cloud through ROS2. Please make sure you have read the LiDAR user-guide before reading this document. **Also please make sure you have read the README.md file and follow the ROS2 compile instructions**
...
```yaml
    ros:
      ...
      ros_send_point_cloud_topic: /rslidar_points      #The topic which used to send point cloud through ROS&ROS2
```
